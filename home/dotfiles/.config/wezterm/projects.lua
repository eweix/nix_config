...
local module = {}
local project_dir = wezterm.home_dir .. "/Documents/GitHub/"

local function project_dirs()
	-- Start with your home directories as a project, 'cause you might want
	...
	local projects = {
		...
		wezterm.home_dir .. "/Library/Mobile Documents/com~apple~CloudDocs/Org",
	}
